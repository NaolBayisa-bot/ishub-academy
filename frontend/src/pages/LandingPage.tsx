...
const categoryRoadmaps: CategoryRoadmap[] = [
  {
    title: 'Cybersecurity',
    color: 'bg-red-500',
...
function BulletItem({ node, index, isVisible, color }: { node: RoadmapNode; index: number; isVisible: boolean; color: string }) {
  return (
    <div
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center flex-wrap gap-x-2 gap-y-0.5 mb-0.5">
          <h4 className={`text-sm font-semibold text-slate-900 dark:text-white transition-all duration-300 ${
          ...
          <span className={`text-[10px] font-mono px-1.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 transition-all duration-300 ${
            ...
            return (
              <div key={cat.title} className="flex flex-col group/cat">
                ...
                >
                  ...
                  {/* Description */}
                  <p className="relative text-sm text-slate-500 dark:text-slate-400 leading-relaxed mb-3
                ...
                >
                  <div className={`rounded-tech p-4 bg-gradient-to-b ${cat.gradient} border border-slate-200 dark:border-tech-border`}>
                    ...
                    >
                      ...
                      <span>~/roadmap/{cat.title.toLowerCase().replace(/\s+/g, '-')}</span>
                    </div>
                    ...
                    >
                      ...
                      ">
                        ...
                        <span>{cat.nodes.length} stages · ~{cat.nodes.reduce((acc, n) => acc + parseInt(n.duration), 0)} weeks total</span>
                      </div>
                    </div>
                  </div>
                </div>
