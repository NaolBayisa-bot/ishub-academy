...
export default function StudentResourcesPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Resources</h1>
      <p className="text-slate-500 dark:text-slate-400 mb-8">Downloadable materials for your category</p>
      ...
      {loading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {resources.map((resource) => (
            <Card key={resource.id} className="p-5 flex flex-col gap-3">
              <div>
